;; Generated by :claw at 2021-10-31T22:17:04.958395Z
(uiop:define-package :%alc (:use))
(uiop:define-package :aw-openal-context-bindings~pristine (:use :cl))
(common-lisp:in-package :aw-openal-context-bindings~pristine)
...
(cffi:defcfun ("alcCaptureOpenDevice" %alc::capture-open-device)
              ...
              (%alc::devicename claw-utils:claw-string)
...
(cffi:defcfun ("alcGetEnumValue" %alc::get-enum-value)
              %alc::enum
              (%alc::device (claw-utils:claw-pointer %alc::device))
              (%alc::enumname claw-utils:claw-string))
...
(cffi:defcfun ("alcGetProcAddress" %alc::get-proc-address)
              (claw-utils:claw-pointer %alc::void)
              (%alc::device (claw-utils:claw-pointer %alc::device))
              (%alc::funcname claw-utils:claw-string))
...
(cffi:defcfun ("alcIsExtensionPresent" %alc::is-extension-present)
              %alc::boolean
              (%alc::device (claw-utils:claw-pointer %alc::device))
              (%alc::extname claw-utils:claw-string))
