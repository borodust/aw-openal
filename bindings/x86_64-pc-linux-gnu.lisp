;; Generated by :claw at 2021-10-31T22:14:31.041098Z
...
(cffi:defcfun ("alGetBooleanv" %al::get-booleanv)
              :void
              (%al::param %al::enum)
              (%al::values claw-utils:claw-string))
...
(cffi:defcfun ("alGetEnumValue" %al::get-enum-value)
              %al::enum
              (%al::ename claw-utils:claw-string))
...
(cffi:defcfun ("alGetProcAddress" %al::get-proc-address)
              ...
              (%al::fname claw-utils:claw-string))
...
(cffi:defcfun ("alIsExtensionPresent" %al::is-extension-present)
              %al::boolean
              (%al::extname claw-utils:claw-string))
